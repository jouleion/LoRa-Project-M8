...
class Sensor:
    def __init__(self, name_of_sensor, known, eui_of_sensor, lon, lat, time_of_flight):
        ...
        self.lon = lon #longitude of sensor
        self.lat = lat   #latitude of sensor
        self.time_of_flight = time_of_flight
        self.nr_of_packets = 0
        self.raw_signals = []
        self.avg_signals = []

    def rssi_model(slef, d, n):
        return transmition_power - 10 * n * np.log10(d)
    def get_lon(self):
        return self.lon
    ...
    def add_signal(self, signal):
        ...
        if self.known:
            ...
            print(self.known_lat, self.known_lon)
        ...
        if len(self.avg_signals) >= 3:
            ...
            print(f'calculated lat, lon: {self.lat}; {self.lon}')
